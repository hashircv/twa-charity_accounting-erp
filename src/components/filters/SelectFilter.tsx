...
export function SelectFilter({
  ...
  return (
    <label ref={wrapperRef} className="relative flex w-full flex-col gap-1 text-xs font-medium text-slate-500 sm:w-auto sm:min-w-36">
      <span>{label}</span>
      <button
      ...
      {isOpen && (
        <div
          className="absolute left-0 right-0 top-full z-30 mt-1 max-h-64 overflow-y-auto rounded border border-slate-200 bg-white shadow-lg dark:border-slate-800 dark:bg-slate-950"
          role="listbox"
        >
